...
{
	public interface IEventAssignTeam : IEventHandler
	{
	...
	public interface IEventSetClass : IEventHandler
	{
	...
	public interface IEventTeamRespawn : IEventHandler
	{
	...
	public interface IEventInitSCP : IEventHandler
	{
		// Called when an SCP is init'd, happens at start of round i think
		void OnInitSCP(TeamClass teamclass);
	}

	public interface IEventDecideTeamRespawnQueue : IEventHandler
	{
	...
	public interface IEventBanSCP : IEventHandler
	{
